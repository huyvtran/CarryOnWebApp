...
export class AdminLayoutComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        /* Set current route and bind route change event */
        this.currRouteName = this.router.url;
        this.router.events.subscribe(ev => {
            if (ev instanceof NavigationStart) {
                this.currRouteName = ev.url;
            }
            // NavigationEnd
            // NavigationCancel
            // NavigationError
    ...
    public isViewBarPresent() {
        if (this.currRouteName === '/dashboard') {
            return false;
        }
